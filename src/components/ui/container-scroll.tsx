...
const Card = ({
  ...
  <motion.div
    ...
    className="-mt-12 mx-auto h-[30rem] w-full max-w-5xl rounded-[30px] border-4 border-zinc-700 bg-zinc-900 p-2 shadow-2xl md:h-[40rem] md:p-6"
  >
    <div className="h-full w-full overflow-hidden rounded-2xl bg-zinc-950 p-4">
      {children}
    </div>
  </motion.div>
);
